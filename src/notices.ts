...
export const noticeCopy = {
  zh: {
    ...
    noticeRescheduleInvalid: '只能把过去的日任务重新安排到更晚的日期。',
    ...
    noticeWrongOwner: '当前账号尚未获得这个看板的访问权限。新建认证账号不会自动授权，请使用已授权账号或联系管理员检查归属配置。',
  ...
  en: {
    ...
    noticeRescheduleInvalid: 'Only unfinished past daily tasks can move to a later date.',
    ...
    noticeWrongOwner: 'This account is not authorized for this board. Creating an Auth user does not grant access; use an authorized account or ask an administrator to check the owner configuration.',
